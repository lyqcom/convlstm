...
import mindspore.dataset.vision.py_transforms as py_t
...
class ImageNet:
    ...
    def __init__(self, args, training=True):
        if True:
            ...
            local_data_path = local_data_path + '/imagenet'
...
def create_dataset_imagenet(dataset_dir, args, repeat_num=1, training=True):
    ...
    if training:
        ...
        transform_img += [
            py_t.ToTensor(),
            py_t.Normalize(mean=mean, std=std),
