...
def parse_arguments():
    ...
    parser.add_argument("--swin_config", help="Config file to use (see configs dir)", default=workroot + '/code/src/configs/CSWin_64_24322_small_224.yaml', required=False)
